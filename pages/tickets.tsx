			...
			<div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
				...
				{programsData?.programs && programsData?.programs.length > 0 ? (
					...
					<div className="my-3 text-center">
						You must add a program first to create voting tickets
						for the audience.{" "}
						<Link
							href={"/programs"}
						...
						<div className="sm:flex sm:items-center border-b py-3 mb-3">
							<div className="sm:flex-auto">
								...
								<p className="mt-2 text-sm text-gray-700">
									This is where you can create unique voting
									tickets for the attendees to the program.
									Each patron should be given one ticket and
									they simply scan the QR code to get the
									voting previlage. This is to limit the
