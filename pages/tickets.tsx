		...
		<Layout>
			<div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
				...
				<div className="sm:flex sm:items-center border-b py-3 mb-3">
					<div className="sm:flex-auto">
						...
						<p className="mt-2 text-sm text-gray-700">
							This is where you can create unique voting tickets
							for the attendees to the program. Each patron should
							be given one ticket and they simply scan the QR code
							to get the voting previlage. This is to limit the
							voting power to the actual attendees.
						</p>
					</div>
				</div>
				<div className="sm:flex sm:items-center items-center justify-center">
					<form onSubmit={handleRegisterTickets(onValidTicketsForm)}>
						<label
							htmlFor="ticket-quantity"
							className="flex items-center justify-center"
						>
							<span className="w-full">Create Extra Tickets</span>
							<input
				...
				<div className="flex flex-col items-center bg-slate-200 p-3 max-w-xl mx-auto rounded-lg my-3">
					...
					>
						<button className="rounded bg-slate-600 px-2 text-xs font-semibold text-white shadow-sm hover:bg-slate-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-600 h-9 sm:ml-1">
							Print/View Tickets
						</button>
					</Link>
					<div className="my-2">
